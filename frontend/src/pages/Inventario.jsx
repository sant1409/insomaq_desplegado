...
export default function Inventario() {
  ...
  const API_URL = `${process.env.REACT_APP_API_URL}/laminas`;
  ...
  const fetchTipos = async () => {
    try {
      const res = await fetch(`${process.env.REACT_APP_API_URL}/tipo-laminas`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (tipoExistente) {
        ...
        const resTipo = await fetch(`${process.env.REACT_APP_API_URL}/tipo-laminas`, {
          method: "POST",
